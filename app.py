...
network_dict = {
  ...
  "RadioSport" : ["927-Mel", "RadioSportDAB-Mel", "RadioSportStreaming-National", "RadioSportStreaming-National", "RadioSportPodcast-National"],
  "Nova" : ["Nova969-Syd", "Nova100-Mel", "Nova1069-Bri", "Nova1069-Bri", "Nova919-Ade", "Nova937-Per", "SmoothFM95.3-Syd", "SmoothFM91.5-Mel"],
...
def review():
 ...
 def filter_stations():
   ...
   for a in list_st:
     if a in network_stations:
       current_network_stations.append(a)
  
   return current_network_stations
 ...
 if len(list_st) >=1 :
     ...
     df = pd.DataFrame([])
     review_station_list = []
     current_network_stations = filter_stations()
     print(current_network_stations)
     for x in range(1,18):
      
      if len(list_st) >= index:
       month = var_list[-index]
       station = current_network_stations[-index]
