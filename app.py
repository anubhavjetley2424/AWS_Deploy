...
def review():
 ...
 if contact_list:
     ...
     if network == 'SEN':
      return render_template("review_SEN.html", form=form, form_1 = form_1, user_image=pic, network=current_user.network,  tables=[df.to_html(classes='data', header="true")], incomplete = incomplete_station_data[0])
