...
class DropdownForm_SEN(FlaskForm):
    ...
    type2 = SelectField(u'Month Code', choices = [(0,'Select'),('2022M01', '2022M01'), ('2022M02', '2022M02'), ('2022M03','2022M03'), ('2022M04', '2022M04'), ('2022M05', '2022M05'), ('2022M06', '2022M06'), ('2022M07', '2022M07'), ('2022M08', '2022M08'), ('2022M09', '2022M09'), ('2022M10', '2022M10'), ('2022M11', '2022M11'), ('2022M12', '2022M12')],  default=month)
...
class DropdownForm_TAB(FlaskForm):
    ...
    type4 = SelectField(u'Station', choices = [(0, 'Select'),('2KY-Syd', '2KY-Syd'), ('4TAB-Bri', '4TAB-Bri'), ('TABDAB-Syd', 'TABDAB-Syd'), ('TABDAB-Mel', 'TABDAB-Mel'), ('TABDAB-Bri', 'TABDAB-Bri'), ('TABDAB-Ade', 'TABDAB-Ade'), ('TABDAB-Per', 'TABDAB-Per'), ('TABStreaming-Metro', 'TABStreaming-Metro'), ('TABPodcast-Metro', 'TABPodcast-Metro')],  default='')
    submit = SubmitField('Submit')
    period_select = SelectField(u'Period', choices = [(0, 'Select'),('All', 'All'), ('Month', 'Month'), ('CYTD', 'CYTD'),('FYTD', 'FYTD')])
    submitrevenue = SubmitField(label="Submit Data")
    calendar_month = SelectField(u'Calendar Month', choices = [(0,'Select'),('2021M10', '2021M10'), ('2021M11', '2021M11')],  default='')
...
def review():
 ...
 if list:
     ...
     for x in range(1,18):
      ...
      if len(station_table) >= index:
       month = var_list[-index]
       station = station_table[-index]
       name = month + "-" + network + "-" + contact + "-" + station + ".db"
       ...
       if station in station_edit_Bri:
         row_df = pd.DataFrame(data = l, columns = ['', 'SydT1', 'SydT2', 'SydDirect', 'MelT1', 'MelT2', 'MelDirect', 'BriT1', 'BriT2', 'BriDirect', 'AdeTotal', 'PerTotal'])
       if station in station_edit_Ade:
         row_df = pd.DataFrame(data = l, columns = ['', 'SydT1', 'SydT2', 'SydDirect', 'MelT1', 'MelT2', 'MelDirect', 'BriTotal', 'AdeT1', 'AdeT2', 'AdeDirect', 'PerTotal'])
       if station in station_edit_Per:
         row_df = pd.DataFrame(data = l, columns = ['', 'SydT1', 'SydT2', 'SydDirect', 'MelT1', 'MelT2', 'MelDirect', 'BriTotal', 'AdeTotal', 'PerT1', 'PerT2', 'PerDirect'])
       if station in station_edit_Mel_Syd:
         row_df = pd.DataFrame(data = l, columns = ['', 'SydT1', 'SydT2', 'SydDirect', 'MelT1', 'MelT2', 'MelDirect', 'BriTotal', 'AdeTotal', 'PerTotal'])
...
def submit():
 ...
 if list:
     ...
     if request.method == 'POST':
        ...
        network_len = len_dict.get(current_user.network)
        if len(station_table) == network_len:
         ...
         remaining_stations = network_len - len(station_table)
