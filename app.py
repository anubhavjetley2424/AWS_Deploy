...
def submit():
 ...
 if contact_list:
     ...
     def table_to_csv(table_milton, df):
        ...
        name_submit = month + "-" + network + "-" + contact_new + "-" + x.strftime('%d') + "-" + x.strftime('%m') + "-" + x.strftime('%H') + "-" + x.strftime('%M') +  "-" + x.strftime('%Y')
        ...
        s3 = boto3.client('s3', aws_access_key_id = 'AKIAWTUKFQZRSQLE7CXM', aws_secret_access_key = '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')
