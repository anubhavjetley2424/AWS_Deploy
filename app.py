...
class DropdownForm_SEN(FlaskForm):
    ...
    type2 = SelectField(u'Month Code', choices = [(0,'Select'),('2022M01', '2022M01'), ('2022M02', '2022M02'), ('2022M03','2022M03'), ('2022M04', '2022M04'), ('2022M05', '2022M05'), ('2022M06', '2022M06'), ('2022M07', '2022M07'), ('2022M08', '2022M08'), ('2022M09', '2022M09'), ('2022M10', '2022M10'), ('2022M11', '2022M11'), ('2022M12', '2022M12')],  default='2022M03')
...
def edit():
 ...
 if len(dashboard_var_list) == 0:
  dashboard_var_list.append('2022M03')
 ...
 if list_st:
     ...
     if request.method == 'POST':
        ...
        if len(incomplete) == 0:
         ...
         return render_template("submit.html", form=form, form_1 = form_1, user_image=pic, network = current_user.network, station=station, message_3 = message_3, message_4 = message_4, contact = contact, month = month, tables=[df.to_html(classes='data', header="true")])
