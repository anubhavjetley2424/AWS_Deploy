...
class DropdownForm_2SM(FlaskForm):
    ...
    submit = SubmitField('Submit')
    period_select = SelectField(u'Period', choices = [(0, 'Select'),('All', 'All'), ('Month', 'Month'), ('CYTD', 'CYTD'),('FYTD', 'FYTD')], render_kw=style)
    submitrevenue = SubmitField(label="Submit")
    calendar_month = SelectField(u'Calendar Month', choices = [(0,'Select'),('2021M10', '2021M10'), ('2021M11', '2021M11')],  default='', render_kw=style)
...
def review():
 ...
 if contact_list:
     ...
     df_incomplete = df_incomplete.set_index('Unedited Stations')
...
def submit():
 ...
 if contact_list:
     ...
     def table_to_csv(table_milton):
      ...
      name = Month + "-" + network + "-" + contact + "-" + x + ".csv"
      compression_opts = dict(method='zip',archive_name=name) 
